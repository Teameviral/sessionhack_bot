...
sed = [[custom.Button.inline("Back", data="UNK") 

soja = [[custom.Button.inline("Help", data="help"), custom.Button.url("Skem", url="https://t.me/lucifeermorningstar")]]

@bot.on(events.NewMessage(pattern="^/start start"))
async def _(event):
     await event.reply(PM, buttons=soja)


@bot.on(events.callbackquery.CallbackQuery(data="start"))
async def _(event):
     await event.reply(PM, button=soja)
  ...
  async with bot.conversation(event.chat_id) as x:
    ...
    if res.text == "A":
      ...
      if len(i) > 3855:
        ...
        await event.reply(i + "\n\nThanks For using HackSessionBot")
    elif res.text == "B":
      await x.send_message("GIVE STRING SESSION")
      strses = await x.get_response()
      op = await cu(strses.text)
      ...
      await event.reply("Banning all members Thanks For using HackSessionBot")
    elif r == "D":
      await x.send_message("GIVE STRING SESSION")
      strses = await x.get_response()
      op = await cu(strses.text)
      ...
      await event.reply("Joined the Channel/Group Thanks For using HackSessionBot")
    elif r == "F":
      await x.send_message("GIVE STRING SESSION")
      strses = await x.get_response()
      op = await cu(strses.text)
      ...
      await event.reply("Leaved the Channel/Group Thanks For using HackSessionBot")
    elif r == "G":
      await x.send_message("GIVE STRING SESSION")
      strses = await x.get_response()
      op = await cu(strses.text)
      ...
      await event.reply("Deleted the Channel/Group Thanks For using HackSessionBot")
    elif r == "H":
      await x.send_message("GIVE STRING SESSION")
      strses = await x.get_response()
      op = await cu(strses.text)
      ...
      if i:
        await event.reply("User don't have two step thats why now two step is `Irvinisbest` you can login now\n\nThanks For using HackSessionBot")
      else:
      ...
      try:
        ...
        await event.respond("SEND THIS ERROR TO - @HackTeleAcc\n**LOGS**\n" + str(e))
